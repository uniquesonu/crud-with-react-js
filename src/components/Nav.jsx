...
const Nav = () => {
  ...
  return (
    <nav className="hidden sm:flex sm:flex-col w-[15%] h-full bg-zinc-100 flex flex-col items-center pt-5 top-0 overflow-y-auto">
      <Button variant="outline" className="w-52 m-4">
        <Link to="/create">Add new product</Link>
      </Button>
      <hr className="my-3 w-[80%] text-gray-900" />
      <h1 className="text-2xl mb-3 font-bold text-center">Category Filter</h1>
      <div className="w-[80%]">
        <Link
          to={`/`}
